const translations = {
  en: {
    ...
    'hero.badge': 'The Operator’s Vision · free for Vegas service businesses',
    'hero.h1': 'Capture the leads <span class="grad">you\u2019re already losing.</span>',
    'hero.lede': "I am a Vegas service business operator. I built an AI ops layer for my own shop that catches every call and kills the back-office drain. Now I build a free Operator\u2019s Vision for other Vegas trades: a clear picture of your whole business running itself.",
    'hero.cta_primary': 'Get your free Operator\u2019s Vision',
    'hero.cta_ghost': 'See the Operator\u2019s Vision',
    'hero.cta_alt_pre': 'Or want the free leak audit instead?',
    'hero.cta_alt_link': 'Get the free 48-hour leak audit →',
    'hero.trust': 'Free · built by an operator who runs his own AI ops stack · English and Spanish',
    ...
    'demo.header_name': 'Annie',
    'demo.status': 'Active now',
    'demo.badge': 'LIVE',
    'demo.b1': "Hey, I'm Annie. What's the one thing slipping through the cracks in your shop?",
    'demo.b2': 'Leads. We miss calls and texts at night.',
    'demo.b3': "That's the leak. About 12 missed leads a month at your ticket size is roughly $23,400 a year gone.",
    'demo.b4': "Your Operator's Vision maps every leak like this in 48 hours, then shows your whole business running without them. Want me to build yours?",
    'demo.b5': "Yes, let's do it.",
    'demo.b6': 'Booked. Check your inbox in 48 hours.',
    'demo.cta': 'Talk to Annie now (2 min call)',
    'demo.caption': 'Live demo. Annie is the same AI agent we install inside your business.',

    'trustbar.t1': 'Real Vegas operator, not an agency',
    'trustbar.t2': 'Built in your stack, you own every credential',
    'trustbar.t3': 'Milestone-gated payments',
    'trustbar.t4': '48-hour delivery',
    'trustbar.t5': 'English and Spanish',

    'stats.days': 'hour turnaround',
    'stats.automations': 'Quick Wins per report',
    'stats.price': 'yours to keep',
    ...
    'assessment.kicker': 'The Operator\u2019s Vision',
    'assessment.h2': 'What you actually get, <span class="grad">free</span>.',
    'assessment.lede': "No 90-day discovery phase. No slide deck disguised as a deliverable. A clear picture of your business running itself, with live examples built on your own business, so you can see exactly what is possible before you spend a dollar.",
    ...
    'assessment.c3_title': 'The bigger results, built for you',
    'assessment.c3_body': "Want more than the free wins? We build the bigger results into your business: leads answered around the clock, the busywork gone, your numbers clean. You only pay if you want it, and you will know the cost on the call.",
    ...
    'assessment.cta': 'Or book a free Discovery Call first',
    ...
    'upsells.kicker': 'Done for you',
    'upsells.h2': "If you want it <span class=\"grad\">done for you</span>, here's what changes.",
    'upsells.lede': "Your Operator's Vision is free, and it shows you what's possible. These are the results we can hand you, built into your business, so you and your team can focus on the work that actually makes money.",
    'upsells.lede_short': "Your free Operator's Vision shows you what's possible. These are the results we can build into your business, so the back office runs itself and you focus on the work that pays.",
    'upsells.cta_see_menu': 'See the results',
    'upsells.audit_title': 'Every ad dollar accounted for',
    'upsells.audit_body': "See exactly which spend turns into real paying customers and which is quietly leaking. The money you were burning goes back to work, instead of into a report you never read.",
    'upsells.zap_title': 'The busywork does itself',
    'upsells.zap_body': 'The repetitive back-office work that eats your day just happens in the background, start to finish, while you do the work that actually pays.',
    'upsells.gpt_title': 'Your answers, ready around the clock',
    'upsells.gpt_body': 'Customers and staff get instant, accurate answers in your voice, any hour, without it landing on you.',
    'upsells.s2l_title': 'No lead ever slips again',
    'upsells.s2l_body': 'Every call and text gets answered in under a minute, day or night, booked and qualified before it has a chance to go cold.',
    'upsells.po_title': 'One smooth flow, no hand-offs',
    'upsells.po_body': 'The messy multi-tool shuffle becomes one clean path. Nothing dropped, nothing re-typed, nothing stuck waiting on you.',
    'upsells.ret_title': 'It keeps getting sharper',
    'upsells.ret_body': 'Your whole setup stays tuned and keeps improving every month as the business grows. You never have to touch the software.',
    'upsells.react_title': 'Dead leads wake back up',
    'upsells.react_body': 'Your old, cold lead list gets worked automatically and quietly turns forgotten contacts back into booked jobs.',
    'upsells.content_title': 'Your content posts itself',
    'upsells.content_body': 'Fresh, on-brand posts and videos go out on a schedule across your channels, without you ever sitting in an app.',
    'upsells.review_title': 'Reviews show up on their own',
    'upsells.review_body': 'Happy customers get asked at the right moment, so your star rating climbs while you stay focused on the work.',
    'upsells.quote_title': 'Quotes and onboarding run themselves',
    'upsells.quote_body': 'New customers go from yes to scheduled without you chasing forms or copying info between apps.',
    'upsells.dash_title': 'One screen shows the whole business',
    'upsells.dash_body': 'Open one tab in the morning and see your leads, jobs, and money, refreshing on its own.',
    'upsells.books_title': 'Your books close themselves',
    'upsells.books_body': 'Receipts log, transactions sort, and the month closes without the Sunday spreadsheet session.',
    'dept.sales': 'Sales',
    'dept.marketing': 'Marketing',
    'dept.support': 'Support',
    'dept.ops': 'Operations',
    'dept.finance': 'Finance',
    'dept.ongoing': 'Ongoing',
    'upsells.audit_cta': 'Start with your free Operator’s Vision',
    'upsells.gated_cta': 'Start with your free Operator’s Vision',
    'upsells.ret_cta': 'Book a call to scope it',
    'upsells.ret_disclaimer': 'For existing AIROIOPS clients with a shipped build. Not sure? Start with your free Operator’s Vision.',
    'assessment.cta_pay': 'Get your free Operator’s Vision',
    'intake.pay_shortcut_title': 'Rather skip the form?',
    'intake.pay_shortcut_lede': 'Talk to our AI specialist now, or book a quick call with Gianny. Your Operator’s Vision is free either way.',
    'intake.pay_shortcut_cta': 'Talk to our AI specialist',
    'upsells.cta': 'Book a call',
    'upsells.cta_alt': 'See a real result in action',
    'upsells.menu_kicker': 'The results',
    'upsells.menu_h2': 'What your business gets, <span class="grad">done for you.</span>',
    'upsells.menu_lede': "Pick the results you want. We build them into your business and you own everything.",
    'upsells.price_audit': 'MONEY',
    'upsells.price_floor': 'DONE FOR YOU',
    'upsells.price_month': 'ONGOING',
    'upsells.cta_h2': 'Ready to <span class="grad">see what is possible?</span>',
    'upsells.cta_body': 'Start with your free Operator’s Vision. We show you which of these results your business can have, then build the ones you want.',
    'upsells.how_builds_work': '<strong style="color:var(--ink);">How it works.</strong> Start with your free Operator’s Vision. It shows you which results fit your business. Then we build the ones you want, into your stack, and you will know exactly what it costs on the call. Only if you want it.',
    'upsells.payment_first_notice': '',

    'faq.ph_lede': 'Whether it really is free, timeline, scope, who it is for, what software it works with, and how the builds work. All seven answers, in one place.',
    ...
    'customers.ph_lede': 'Each story is an SMB that ran their free Operator’s Vision, then shipped one or more of the builds. We publish the work, the numbers, and the stack used. No vague claims.',
    'customers.stat1': 'Free Operator’s Vision behind every story',
    ...
    'customers.featured_lede': 'A two-chapter case study. Chapter 1 is the free Operator’s Vision deliverable. Chapter 2 is what got built after.',
    'customers.ch1_tag': 'Chapter 1 of 2 &middot; The Operator’s Vision',
    'customers.ch1_title': 'The Operator’s Vision, run on a real service business',
    ...
    'customers.ch1_cta': 'Read the Operator’s Vision',
    'customers.ch2_tag': 'Chapter 2 of 2 &middot; The Rebuild',
    'customers.ch2_title': 'What got built after the Operator’s Vision',
    ...
    'customers.more_lede': 'The first 5 free Operator’s Visions. Each story is published once the rebuild ships and the numbers are in.',
    'customers.soon_tag': 'Coming soon',
    'customers.soon_title': 'Free-5 customer story',
    'customers.soon_body': 'One of the first 5 free Operator’s Visions. Story published once the rebuild ships and the numbers are in.',
    'customers.cta_h2': 'Want this run on <span class="grad">your business?</span>',
    'customers.cta_body': 'Free Operator’s Vision for your business. A clear 48-hour picture of your operation running itself, with live examples built on your own business.',
    ...
    'how.h2': 'Three steps. <span class="grad">The vision is free.</span>',
    'how.day1': 'Step 1',
    'how.s1_title': 'Get your free Operator’s Vision',
    'how.s1_body': 'Tell us about your business in a quick form, or talk it through with Annie. In 48 hours you get a clear picture of your whole operation running itself, built on your real business. Free, no card.',
    'how.day2': 'Step 2',
    'how.s2_title': 'Walk through it together',
    'how.s2_body': "We hop on a short call and go through what is possible, what is leaking, and what it looks like once it is handled. No pressure. Just your business, clearer.",
    'how.day3': 'Step 3',
    'how.s3_title': 'We build the parts you want',
    'how.s3_body': 'Pick what you want made real and I do the hard work, wired into your business. That part is paid, and you will know exactly what it costs on the call. Only if you want it.',
    'how.cta': 'Get your free Operator’s Vision',
    ...
    'about.body2': "The Operator's Vision isn't a deck. It's the same playbook I run on my own ops, a clear picture of your business running itself, delivered in 48 hours. The quick wins are yours to ship today; the bigger builds are there if you'd rather hand off.",
    'about.cta': 'Book Your Discovery Call',

    'faq.kicker': 'FAQ',
    'faq.lede_short': 'Whether it really is free, timeline, scope, who it is for, what software it works with, how the builds work. Full answers on one page.',
    'faq.cta_see': 'Read all 7 FAQs',
    'faq.h2': 'Common questions about <span class="grad">AI for business owners.</span>',
    'faq.q1': 'Is the Operator’s Vision really free?',
    'faq.a1': 'Yes, the Operator’s Vision is free. You get an operations audit, live examples built on your own business, and a clear picture of your business running itself, delivered in 48 hours, plus a 20-minute walk-through call. No card, no catch.',
    'faq.q2': 'How long does the Operator’s Vision take?',
    'faq.a2': '48 hours from the time you complete the intake. You can fill the deep-dive intake on your own time or book a 45-minute discovery call. Either way, your Operator’s Vision lands in your inbox 48 hours later.',
    'faq.q3': 'Do you only serve businesses in Las Vegas?',
    'faq.a3': 'No. We work with business owners of any size across the entire United States. The Operator’s Vision runs over email and one short call, so geography is not a constraint. We are headquartered in Las Vegas, NV, and local Vegas-area service businesses get an optional in-person session if they want it.',
    'faq.q4': 'What is included in the Operator’s Vision?',
    'faq.a4': 'An operations audit of your tools and workflows, live examples built on your own business (a working AI assistant, a sample video, a refreshed home page), and a clear map of every leak and how it gets handled automatically. All delivered in 48 hours, plus a 20-minute walk-through call.',
    ...
    'faq.q7': 'What do the bigger builds cost?',
    'faq.a7': 'Every build is custom-scoped on a call after your Operator’s Vision. We quote it in writing before you commit, built in your stack, your credentials. The Vision shows you the upside first, so the numbers make sense before you spend anything.',
    ...
    'intake.meta_title': 'Operator’s Vision Intake | AIROIOPS',
    'intake.back': 'Back to airoiops.com',
    'intake.eyebrow': 'The Operator’s Vision · Free Intake',
  ...
  es: {
    ...
    'hero.badge': 'La Visión del Operador · gratis para negocios de servicio en Vegas',
    'hero.h1': 'Captura los clientes <span class="grad">que estás perdiendo.</span>',
    'hero.lede': 'Soy operador de un negocio de servicios en Las Vegas. Construí una capa de IA para mi propio negocio que atrapa cada llamada y elimina el trabajo administrativo. Ahora construyo una Visión del Operador gratis para otros oficios en Vegas: una imagen clara de todo tu negocio funcionando solo.',
    'hero.cta_primary': 'Obtén tu Visión del Operador gratis',
    'hero.cta_ghost': 'Ver la Visión del Operador',
    'hero.cta_alt_pre': '¿Prefieres la auditoría gratuita?',
    'hero.cta_alt_link': 'Obtén la auditoría gratuita de 48 horas →',
    'hero.trust': 'Gratis · hecho por un operador que corre su propio stack de IA · inglés y español',
    ...
    'demo.header_name': 'Annie',
    'demo.status': 'Activa ahora',
    'demo.badge': 'EN VIVO',
    'demo.b1': 'Hola, soy Annie. ¿Qué es lo que se te escapa en el negocio?',
    'demo.b2': 'Leads. Perdemos llamadas y mensajes de noche.',
    'demo.b3': 'Esa es la fuga. Unos 12 leads perdidos al mes a tu ticket son cerca de $23,400 al año perdidos.',
    'demo.b4': "Tu Visión del Operador mapea cada fuga así en 48 horas, y luego te muestra todo tu negocio funcionando sin ellas. ¿Te la construyo?",
    'demo.b5': 'Sí, hagámoslo.',
    'demo.b6': 'Reservada. Revisa tu correo en 48 horas.',
    'demo.cta': 'Habla con Annie ahora (llamada de 2 min)',
    'demo.caption': 'Demo en vivo. Annie es el mismo agente de IA que instalamos en tu negocio.',

    'trustbar.t1': 'Operador real de Las Vegas, no una agencia',
    'trustbar.t2': 'Construido en tu stack, tú eres dueño de cada credencial',
    'trustbar.t3': 'Pagos por hitos',
    'trustbar.t4': 'Entrega en 48 horas',
    'trustbar.t5': 'Inglés y español',

    'stats.days': 'horas para entregar',
    'stats.automations': 'Quick Wins por reporte',
    'stats.price': 'tuya para siempre',
    ...
    'assessment.kicker': 'La Visión del Operador',
    'assessment.h2': 'Lo que realmente obtienes, <span class="grad">gratis</span>.',
    'assessment.lede': 'Sin fase de descubrimiento de 90 días. Sin presentación disfrazada de entregable. Una imagen clara de tu negocio funcionando solo, con ejemplos en vivo hechos sobre tu propio negocio, para que veas exactamente qué es posible antes de gastar un dólar.',
    ...
    'assessment.c3_title': 'Los resultados grandes, hechos por ti',
    'assessment.c3_body': '¿Quieres más que las victorias gratis? Construimos los resultados grandes en tu negocio: leads atendidos a toda hora, el trabajo repetitivo eliminado, tus números limpios. Solo pagas si lo quieres, y sabrás el costo en la llamada.',
    ...
    'assessment.cta': 'O agenda una llamada gratis primero',
    ...
    'upsells.kicker': 'Hecho por ti',
    'upsells.h2': 'Si quieres que <span class="grad">lo hagamos por ti</span>, esto es lo que cambia.',
    'upsells.lede': 'Tu Visión del Operador es gratis, y te muestra lo que es posible. Estos son los resultados que podemos entregarte, integrados en tu negocio, para que tú y tu equipo se enfoquen en el trabajo que de verdad genera dinero.',
    'upsells.audit_title': 'Cada dólar de anuncios bien contado',
    'upsells.audit_body': 'Ve exactamente qué gasto se convierte en clientes que pagan y cuál se está fugando. El dinero que estabas quemando vuelve a trabajar, en lugar de irse a un reporte que nunca lees.',
    'upsells.zap_title': 'El trabajo repetitivo se hace solo',
    'upsells.zap_body': 'El trabajo administrativo repetitivo que se come tu día simplemente ocurre en segundo plano, de principio a fin, mientras tú haces el trabajo que de verdad paga.',
    'upsells.gpt_title': 'Tus respuestas, listas a toda hora',
    'upsells.gpt_body': 'Clientes y equipo reciben respuestas instantáneas y precisas con tu voz, a cualquier hora, sin que te caiga a ti.',
    'upsells.s2l_title': 'Ningún lead se vuelve a escapar',
    'upsells.s2l_body': 'Cada llamada y mensaje se responde en menos de un minuto, de día o de noche, agendado y calificado antes de que tenga oportunidad de enfriarse.',
    'upsells.po_title': 'Un flujo limpio, sin traspasos',
    'upsells.po_body': 'El desorden de saltar entre herramientas se vuelve un solo camino limpio. Nada se cae, nada se re-escribe, nada se queda esperándote.',
    'upsells.ret_title': 'Cada mes se afina más',
    'upsells.ret_body': 'Todo tu sistema se mantiene afinado y sigue mejorando cada mes a medida que el negocio crece. Nunca tienes que tocar el software.',
    'upsells.react_title': 'Los leads muertos reviven',
    'upsells.react_body': 'Tu lista vieja de leads fríos se trabaja automáticamente y convierte, sin ruido, contactos olvidados en trabajos agendados.',
    'upsells.content_title': 'Tu contenido se publica solo',
    'upsells.content_body': 'Publicaciones y videos frescos y con tu marca salen en un calendario en todos tus canales, sin que te sientes nunca en una app.',
    'upsells.review_title': 'Las reseñas llegan solas',
    'upsells.review_body': 'A los clientes contentos se les pide en el momento justo, así tu calificación sube mientras tú te enfocas en el trabajo.',
    'upsells.quote_title': 'Cotizaciones y onboarding solos',
    'upsells.quote_body': 'Los clientes nuevos pasan del sí a agendados sin que persigas formularios ni copies datos entre apps.',
    'upsells.dash_title': 'Una pantalla muestra todo el negocio',
    'upsells.dash_body': 'Abres una sola pestaña en la mañana y ves tus leads, trabajos y dinero, actualizándose solos.',
    'upsells.books_title': 'Tus libros se cierran solos',
    'upsells.books_body': 'Los recibos se registran, las transacciones se clasifican, y el mes se cierra sin la sesión de hoja de cálculo del domingo.',
    'dept.sales': 'Ventas',
    'dept.marketing': 'Marketing',
    'dept.support': 'Soporte',
    'dept.ops': 'Operaciones',
    'dept.finance': 'Finanzas',
    'dept.ongoing': 'Continuo',
    'upsells.audit_cta': 'Empieza con tu Visión del Operador gratis',
    'upsells.gated_cta': 'Empieza con tu Visión del Operador gratis',
    'upsells.ret_cta': 'Agenda una llamada para definirlo',
    'upsells.ret_disclaimer': 'Para clientes existentes de AIROIOPS con una construcción ya entregada. ¿No estás seguro? Empieza con tu Visión del Operador gratis.',
    'assessment.cta_pay': 'Obtén tu Visión del Operador gratis',
    'intake.pay_shortcut_title': '¿Prefieres saltar el formulario?',
    'intake.pay_shortcut_lede': 'Habla con nuestra especialista en IA ahora, o agenda una llamada rápida con Gianny. Tu Visión del Operador es gratis de cualquier forma.',
    'intake.pay_shortcut_cta': 'Habla con nuestra especialista en IA',
    'upsells.cta': 'Agenda una llamada',
    'upsells.cta_alt': 'Ver un resultado real en acción',
    'upsells.menu_kicker': 'Los resultados',
    'upsells.menu_h2': 'Lo que tu negocio obtiene, <span class="grad">sin que muevas un dedo.</span>',
    'upsells.menu_lede': 'Elige los resultados que quieres. Los integramos en tu negocio y tú eres dueño de todo.',
    'upsells.price_audit': 'DINERO',
    'upsells.price_floor': 'HECHO POR TI',
    'upsells.price_month': 'CONTINUO',
    'upsells.cta_h2': '¿Listo para <span class="grad">ver lo que es posible?</span>',
    'upsells.cta_body': 'Empieza con tu Visión del Operador gratis. Te mostramos cuáles de estos resultados puede tener tu negocio, y luego construimos los que quieras.',
    'upsells.how_builds_work': '<strong style="color:var(--ink);">Cómo funciona.</strong> Empieza con tu Visión del Operador gratis. Te muestra cuáles resultados encajan con tu negocio. Luego construimos los que quieras, en tu stack, y sabrás exactamente cuánto cuesta en la llamada. Solo si lo quieres.',
    'upsells.payment_first_notice': '',

    'faq.ph_lede': 'Si de verdad es gratis, tiempos, alcance, para quién es, con qué software funciona, y cómo funcionan las construcciones. Las siete respuestas, en un solo lugar.',
    ...
    'customers.ph_lede': 'Cada historia es una pequeña empresa que hizo su Visión del Operador gratis y luego lanzó una o más de las construcciones. Publicamos el trabajo, los números y el stack usado. Sin afirmaciones vagas.',
    'customers.stat1': 'Visión del Operador gratis detrás de cada historia',
    ...
    'customers.featured_lede': 'Un caso de estudio de dos capítulos. El Capítulo 1 es el entregable de la Visión del Operador gratis. El Capítulo 2 es lo que se construyó después.',
    'customers.ch1_tag': 'Capítulo 1 de 2 &middot; La Visión del Operador',
    'customers.ch1_title': 'La Visión del Operador, hecha en un negocio de servicios real',
    ...
    'customers.ch1_cta': 'Leer la Visión del Operador',
    'customers.ch2_tag': 'Capítulo 2 de 2 &middot; La Reconstrucción',
    'customers.ch2_title': 'Lo que se construyó después de la Visión del Operador',
    ...
    'customers.more_lede': 'Las primeras 5 Visiones del Operador gratuitas. Cada historia se publica una vez que la reconstrucción se entrega y los números están listos.',
    'customers.soon_tag': 'Muy pronto',
    'customers.soon_title': 'Historia de cliente Free-5',
    'customers.soon_body': 'Una de las primeras 5 Visiones del Operador gratuitas. Historia publicada una vez que la reconstrucción se entrega y los números están listos.',
    'customers.cta_h2': '¿Quieres esto en <span class="grad">tu negocio?</span>',
    'customers.cta_body': 'Visión del Operador gratis para tu negocio. Una imagen clara en 48 horas de tu operación funcionando sola, con ejemplos en vivo hechos sobre tu propio negocio.',
    ...
    'how.h2': 'Tres pasos. <span class="grad">La visión es gratis.</span>',
    'how.day1': 'Paso 1',
    'how.s1_title': 'Obtén tu Visión del Operador gratis',
    'how.s1_body': 'Cuéntanos sobre tu negocio en un formulario rápido, o platícalo con Annie. En 48 horas recibes una imagen clara de toda tu operación funcionando sola, hecha sobre tu negocio real. Gratis, sin tarjeta.',
    'how.day2': 'Paso 2',
    'how.s2_title': 'Lo revisamos juntos',
    'how.s2_body': 'Nos subimos a una llamada corta y repasamos qué es posible, qué se está fugando, y cómo se ve una vez resuelto. Sin presión. Solo tu negocio, más claro.',
    'how.day3': 'Paso 3',
    'how.s3_title': 'Construimos lo que tú quieras',
    'how.s3_body': 'Eliges qué quieres hacer realidad y yo hago el trabajo duro, integrado en tu negocio. Esa parte es de pago, y sabrás exactamente cuánto cuesta en la llamada. Solo si la quieres.',
    'how.cta': 'Obtén tu Visión del Operador gratis',
    ...
    'about.body2': 'La Visión del Operador no es una presentación. Es el mismo playbook que ejecuto en mis propias operaciones, una imagen clara de tu negocio funcionando solo, entregada en 48 horas. Los quick wins son tuyos para lanzar hoy; las construcciones más grandes están ahí si prefieres delegar.',
    ...
    'faq.q1': '¿La Visión del Operador es realmente gratis?',
    'faq.a1': 'Sí, la Visión del Operador es gratis. Recibes una auditoría de operaciones, ejemplos en vivo hechos sobre tu propio negocio, y una imagen clara de tu negocio funcionando solo, entregada en 48 horas, más una llamada de repaso de 20 minutos. Sin tarjeta, sin trampa.',
    'faq.q2': '¿Cuánto tarda la Visión del Operador?',
    'faq.a2': '48 horas desde que completas el cuestionario. Puedes llenar el cuestionario detallado a tu ritmo o agendar una llamada de 45 minutos. De cualquier forma, tu Visión del Operador llega a tu correo 48 horas después.',
    'faq.q3': '¿Solo atienden a negocios en Las Vegas?',
    'faq.a3': 'No. Trabajamos con dueños de negocio de cualquier tamaño en todo Estados Unidos. La Visión del Operador se hace por correo y una llamada corta, así que la geografía no es una restricción. Tenemos sede en Las Vegas, NV, y los negocios de servicio locales en el área de Vegas tienen la opción de una sesión presencial si la quieren.',
    'faq.q4': '¿Qué incluye la Visión del Operador?',
    'faq.a4': 'Una auditoría de operaciones de tus herramientas y flujos, ejemplos en vivo hechos sobre tu propio negocio (un asistente de IA funcionando, un video de muestra, una página de inicio renovada), y un mapa claro de cada fuga y cómo se maneja automáticamente. Todo entregado en 48 horas, más una llamada de repaso de 20 minutos.',
    ...
    'faq.q7': '¿Cuánto cuestan las construcciones más grandes?',
    'faq.a7': 'Cada construcción se define a medida en una llamada después de tu Visión del Operador. La cotizamos por escrito antes de que te comprometas, hecha en tu stack, tus credenciales. La Visión te muestra el potencial primero, para que los números tengan sentido antes de gastar nada.',
    ...
    'intake.meta_title': 'Visión del Operador | AIROIOPS',
    'intake.back': 'Volver a airoiops.com',
    'intake.eyebrow': 'La Visión del Operador · Formulario gratis',
