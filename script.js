const translations = {
  en: {
    ...
    'hero.badge': 'Free 48-hour ad-spend leak audit · No call required',
    'hero.h1': 'AI ops for service businesses + multi-location operators. <span class="grad">The work that survives 2027.</span>',
    'hero.lede': "I run a real Vegas service business with 100+ active clients. I ship AI ops on it daily. I know what works because I do it. Get your 3 biggest ad-spend leaks in 48 hours, free. Then decide if you want help fixing them.",
    'hero.cta_primary': 'Get your free 48-hour leak audit',
    'hero.cta_ghost': 'See the Assessment',
    'hero.cta_alt_pre': 'Want the full assessment instead?',
    'hero.cta_alt_link': 'Book the $1,500 paid assessment →',
    'hero.trust': '$1,500 fixed price assessment · Milestone-gated payments · You see every dollar of work in real time',
    ...
    'upsells.gated_cta': 'Start with the $1,500 Assessment',
  ...
  es: {
    ...
    'hero.badge': 'Auditoría gratuita de 48 horas para fugas en publicidad · Sin llamada requerida',
    'hero.h1': 'Operaciones de IA para negocios de servicios y operadores multi-ubicación. <span class="grad">El trabajo que sobrevive 2027.</span>',
    'hero.lede': 'Manejo un negocio de servicios real en Las Vegas con más de 100 clientes activos. Implemento operaciones de IA diariamente. Sé lo que funciona porque lo hago. Recibe gratis las 3 mayores fugas en tu inversión publicitaria en 48 horas. Luego decides si quieres ayuda para arreglarlas.',
    'hero.cta_primary': 'Obtén tu auditoría gratuita de 48 horas',
    'hero.cta_ghost': 'Ver la evaluación',
    'hero.cta_alt_pre': '¿Prefieres la evaluación completa?',
    'hero.cta_alt_link': 'Reserva la evaluación pagada de $1,500 →',
    'hero.trust': 'Evaluación de $1,500 a precio fijo · Pagos por hitos · Ves cada dólar de trabajo en tiempo real',
    ...
    'upsells.gated_cta': 'Empieza con la Evaluación de $1,500',
