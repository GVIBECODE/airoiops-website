const translations = {
  en: {
    'meta.title': "AIROIOPS | The Operator's Audit for Las Vegas service businesses",
    ...
    'hero.badge': 'First 5 paid Vegas trades: $997 · promo OPERATOR997',
    'hero.h1': 'Capture the leads <span class="grad">you\u2019re already losing.</span>',
    'hero.lede': "I am a Vegas service business operator. I built an AI ops layer for my own shop that catches every call and kills the back-office drain. Now I run a $1,500 Operator\u2019s Audit for other Vegas trades. First 5 paid: $997.",
    'hero.cta_primary': 'Lock the $997 founding rate',
    'hero.cta_ghost': 'See the Operator\u2019s Audit',
    'hero.cta_alt_pre': 'Or want the free leak audit instead?',
    'hero.cta_alt_link': 'Get the free 48-hour leak audit →',
    'hero.trust': '$1,500 firm · $997 first 5 paid Vegas trades · Built by an operator who runs his own AI ops stack',
    ...
    'demo.b4': "Your Operator's Audit maps every leak like this in 48 hours, then we plug them. Want me to book yours?",
    ...
    'assessment.kicker': 'The Operator\u2019s Audit',
    ...
    'upsells.ret_body': 'Ongoing optimization and maintenance to keep your AIROIOPS-built systems running, including monthly check-ins, small adjustments, and a 90-day metrics review. Major new builds quoted separately. Cancel anytime. Most clients start this after their first build ships.',
    'upsells.audit_cta': 'Pay $1,500 and start now',
    'upsells.gated_cta': 'Start with the Assessment',
    'upsells.ret_cta': 'Subscribe at $1,500/month',
    'upsells.ret_disclaimer': 'For existing AIROIOPS clients with a shipped build. Not sure? Start with the Assessment first.',
    'assessment.cta_pay': 'Pay $1,500 and start now',
    'intake.pay_shortcut_title': 'Already know you want it?',
    'intake.pay_shortcut_lede': 'Pay $1,500 now and skip ahead. Or fill out the questionnaire below first if you prefer. Either way, your custom report only ships after payment is received.',
    'intake.pay_shortcut_cta': 'Pay $1,500',
    ...
    'upsells.cta_body': 'Start with the Assessment. We quantify your ROI in writing first, so the math is on paper before any build contract.',
  ...
  es: {
    'meta.title': 'AIROIOPS | La Auditoría del Operador para negocios de servicio en Las Vegas',
    ...
    'hero.badge': 'Primeros 5 oficios de Vegas pagados: $997 · código OPERATOR997',
    'hero.h1': 'Captura los clientes <span class="grad">que estás perdiendo.</span>',
    'hero.lede': 'Soy operador de un negocio de servicios en Las Vegas. Construí una capa de IA para mi propio negocio que atrapa cada llamada y elimina el trabajo administrativo. Ahora ofrezco la Auditoría del Operador de $1,500 a otros oficios en Vegas. Primeros 5 pagados: $997.',
    'hero.cta_primary': 'Asegura la tarifa fundadora de $997',
    'hero.cta_ghost': 'Ver la evaluación',
    'hero.cta_alt_pre': '¿Prefieres la evaluación completa?',
    'hero.cta_alt_link': 'Obtén la auditoría gratuita de 48 horas →',
    'hero.trust': '$1,500 fijo · $997 los primeros 5 negocios de Vegas · Hecho por un operador que corre su propio stack de IA',
    ...
    'demo.b4': "Tu Operator's Audit mapea cada fuga así en 48 horas, y luego las tapamos. ¿Te la reservo?",
    ...
    'upsells.ret_body': 'Optimización continua y mantenimiento para mantener tus sistemas construidos por AIROIOPS funcionando, incluyendo check-ins mensuales, ajustes pequeños y una revisión de métricas a los 90 días. Las construcciones nuevas grandes se cotizan por separado. Cancela cuando quieras. La mayoría de clientes empieza esto después de que su primera construcción se entregue.',
    'upsells.audit_cta': 'Paga $1,500 y empieza ahora',
    'upsells.gated_cta': 'Empieza con la Evaluación',
    'upsells.ret_cta': 'Suscríbete a $1,500/mes',
    'upsells.ret_disclaimer': 'Para clientes existentes de AIROIOPS con una construcción ya entregada. ¿No estás seguro? Empieza con la Evaluación primero.',
    'assessment.cta_pay': 'Paga $1,500 y empieza ahora',
    'intake.pay_shortcut_title': '¿Ya sabes que lo quieres?',
    'intake.pay_shortcut_lede': 'Paga $1,500 ahora y avanza. O llena el cuestionario de abajo primero si prefieres. De cualquier forma, tu reporte personalizado solo se envía después de recibir el pago.',
    'intake.pay_shortcut_cta': 'Paga $1,500',
    ...
    'upsells.cta_body': 'Empieza con la Evaluación. Cuantificamos tu ROI por escrito primero, así los números están en papel antes de cualquier contrato de construcción.',
