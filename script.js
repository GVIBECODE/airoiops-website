const translations = {
  en: {
    ...
    'intake.pay_shortcut_lede': 'Pay $1,500 now and skip the intake form. We will email you the same questions after payment.',
  ...
  es: {
    ...
    'intake.pay_shortcut_lede': 'Paga $1,500 ahora y salta el formulario. Te mandaremos las mismas preguntas por email después del pago.',
