const translations = {
  en: {
    'meta.title': 'AIROIOPS — AI Assessments for Small Business',
    ...
    'assessment.c2_title': '3 Automation Candidates',
    'assessment.c2_body': 'Ranked by ROI, effort, and risk. Each one has projected hours saved, dollar impact, and a clear build path you can take to any developer.',
    'assessment.c3_title': 'One Live Build',
    'assessment.c3_body': 'We ship the top automation in your stack. Working code, deployed, owned by you. Not a prototype. Not a demo. A real production tool.',
    'assessment.c4_title': '90-Day Roadmap',
    'assessment.c4_body': 'The path from one automation to a fully AI-leveraged ops stack. Quarterly milestones, prioritized backlog, no fluff.',

    'how.kicker': 'How it works',
    'how.h2': 'One week. Three steps. <span class="grad">Real ROI.</span>',
    'how.day1': 'Day 1',
    'how.s1_title': 'Discovery Call',
    'how.s1_body': '45 minutes. We learn your business, your tools, and your biggest time sinks. Free, no commitment.',
    'how.day2': 'Day 2 — 4',
    'how.s2_title': 'Audit &amp; Identify',
    'how.s2_body': 'We dig in. Map every workflow. Score automations by ROI. Pick the winner with you.',
    'how.day3': 'Day 5 — 7',
    'how.s3_title': 'Build &amp; Deliver',
    'how.s3_body': 'Ship the live automation. Document the roadmap. Hand off the keys. You own everything.',
    ...
    'proof.body': 'A real Las Vegas service business sitting on a year of lead-gen ad spend with no follow-up system. We applied the Assessment, identified the lead recovery automation as the #1 ROI play, and shipped it. The same playbook we sell, run on a real P&amp;L.',
    ...
    'about.body2': "The Assessment isn't a deck. It's the same playbook I run on my own ops, packaged so you walk away with a working automation in seven days.",
  ...
  es: {
    'meta.title': 'AIROIOPS — Evaluaciones de IA para Pequeñas Empresas',
    ...
    'assessment.c2_title': '3 candidatos de automatización',
    'assessment.c2_body': 'Clasificadas por ROI, esfuerzo y riesgo. Cada una incluye horas proyectadas ahorradas, impacto en dólares, y un camino claro de construcción que puedes llevar a cualquier desarrollador.',
    'assessment.c3_title': 'Una construcción en vivo',
    'assessment.c3_body': 'Lanzamos la automatización principal en tu stack. Código funcional, desplegado, tuyo. No un prototipo. No una demo. Una herramienta real en producción.',
    'assessment.c4_title': 'Hoja de ruta de 90 días',
    'assessment.c4_body': 'El camino de una automatización a un stack de operaciones totalmente potenciado por IA. Hitos trimestrales, backlog priorizado, sin relleno.',

    'how.kicker': 'Cómo funciona',
    'how.h2': 'Una semana. Tres pasos. <span class="grad">ROI real.</span>',
    'how.day1': 'Día 1',
    'how.s1_title': 'Llamada de descubrimiento',
    'how.s1_body': '45 minutos. Aprendemos tu negocio, tus herramientas, y tus mayores pérdidas de tiempo. Gratis, sin compromiso.',
    'how.day2': 'Día 2 — 4',
    'how.s2_title': 'Auditar e identificar',
    'how.s2_body': 'Investigamos a fondo. Mapeamos cada flujo. Calificamos automatizaciones por ROI. Elegimos la ganadora contigo.',
    'how.day3': 'Día 5 — 7',
    'how.s3_title': 'Construir y entregar',
    'how.s3_body': 'Lanzamos la automatización en vivo. Documentamos la hoja de ruta. Entregamos las llaves. Tú eres dueño de todo.',
    ...
    'proof.body': 'Un negocio real de servicios en Las Vegas con un año de inversión en publicidad sin sistema de seguimiento. Aplicamos la evaluación, identificamos la automatización de recuperación de leads como la jugada #1 de ROI, y la lanzamos. El mismo playbook que vendemos, ejecutado en un P&amp;L real.',
    ...
    'about.body2': 'La evaluación no es una presentación. Es el mismo playbook que ejecuto en mis propias operaciones, empaquetado para que te lleves una automatización funcional en siete días.',
